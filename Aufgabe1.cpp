...
Object determine_choice(string choice)
{
    ...
    else
    {
        ...
        //      srand() initialisiert den Zufallszahlengenerator mit einem Startwert (Seed),
        ...
        //     ein anderer Seed verwendet, wodurch die Zufallszahlen unterschiedlich sind.
        ...
        //      Mit "rand() % 3" wird der Wertebereich von rand() auf drei mögliche Ergebnisse reduziert:
        //      0, 1 oder 2 – passend zu den drei Objekten (Stein, Schere, Papier).
...
{
    std::cout << player.name << " hat das Objekt " << get_name(player.choice) << " gewählt" << endl;
}
