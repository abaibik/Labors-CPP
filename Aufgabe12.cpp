...
void cell(std::string name, int value) {
  std::cout << "---------------------" << std::endl;
...
void search(std::string names[], int *p_values[], int n) {
...
class C1 : public B {
public:
  C1(int a = 0xC1A, int b = 0xC1B) : B(a, b) {}
};

class C2 : virtual public B {
public:
  C2(int a = 0xC2A, int b = 0xC2B) : B(a, b) {}
};

class C3 : virtual public B {
public:
  C3(int a = 0xC3A, int b = 0xC3B) : B(a, b) {}
};

class D1 : public C2, public C3 {
public:
  D1(int c2_a = 0xD1C2A, int c3_a = 0xD1C3A, int c2_b = 0xD1C2B,
     int c3_b = 0xD1C3B)
      : A(0xD1A), C2(c2_a, c2_b), C3(c3_a, c3_b) {}
  void print() {
    std::cout << "D1::print() ..." << std::endl;
    std::string names[] = {"C2::a", "C3::a", "C2::b", "C3::b"};
...
public:
  D2(int c1_a = 0xD2C1A, int c2_a = 0xD2C2A, int c3_a = 0xD2C3A,
     int c1_b = 0xD2C1B, int c2_b = 0xD2C2B, int c3_b = 0xD2C3B)
      : B(0xBA, 0xD2B), C1(c1_a, c1_b), C2(c2_a, c2_b), C3(c3_a, c3_b) {}

  void print() {
    std::cout << "D2::print() ..." << std::endl;
    std::string names[] = {"C1::a", "C2::a", "C3::a",
                           "C1::b", "C2::b", "C3::b"};
    int *p_values[] = {&(C1::_a), &(C2::_a), &(C3::_a),
                       &(C1::_b), &(C2::_b), &(C3::_b)};
